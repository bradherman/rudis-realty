...
<h3 class="tableHEADER">Forgotten Password</h3>
<br>
<form name="commerciallogin" method="post" action="forgot_password.php">
  <table border="0" align="center" cellpadding="0" cellspacing="0">
    <tr> 
      <td width="75" class="tableBODY">Email</td>
      <td><input name="email" type="text" class="formFIELD" id="email" size="30" maxlength="50"></td>
    </tr>
    <tr> 
      <td width="75" class="tableBODY"><br> </td>
      <td><br> <input name="Send" type="submit" class="formBUTTON" id="Send" value="Send"></td>
    </tr>
    <tr class="tableBODY">
      <td width="75">&nbsp;</td>
      <td>&nbsp;</td>
    ...
    <tr class="tableBODY">
      <td width="75">&nbsp;</td>
      <td><a href="login.php">Return to login page</a></td>
    </tr>
  </table>
</form>
<br>
