...
<!-- END HEADER AND NAV BAR; BEGIN PAGE CONTENT  -->
<h3 class="tableHEADER">Register</h3>
<br>
<form name="form1" method="post" action="register.php">
  ...
  <table border="0" align="center" cellpadding="0" cellspacing="0">
    <tr> 
      <td>&nbsp;</td>
      <td width="200" class="tableSUBSECTION">Account Information</td>
      <td>&nbsp;</td>
    </tr>
    <tr> 
      <td class="tableREQUIRED">*&nbsp;</td>
      <td width="200" class="tableBODY">Username</td>
      <td><input name="username" type="text" class="formFIELD" id="username" value="" size="30" maxlength="50"></td>
    </tr>
    <tr> 
      <td class="tableREQUIRED">*</td>
      <td width="200" class="tableBODY">Password</td>
      <td><input name="password" type="password" class="formFIELD" id="password" size="30" maxlength="50"></td>
    </tr>
    <tr> 
      <td class="tableREQUIRED">*</td>
      <td width="200" class="tableBODY">Re-type Password</td>
      <td><input name="password2" type="password" class="formFIELD" id="password2" size="30" maxlength="50"></td>
    </tr>
    <tr> 
      <td class="tableREQUIRED">*</td>
      <td width="200" class="tableBODY">Email</td>
      <td><input name="email" type="text" class="formFIELD" id="email" value="" size="30" maxlength="50"></td>
    </tr>
    <tr> 
      <td class="tableREQUIRED">&nbsp;</td>
      <td width="200" class="tableREQUIRED">* denotes required information</td>
      <td>&nbsp;</td>
    </tr>
    <tr> 
      <td class="tableREQUIRED">&nbsp;</td>
      <td width="200" class="tableSUBSECTION">Contact Information</td>
      <td>&nbsp;</td>
    </tr>
    <tr> 
      <td class="tableREQUIRED">&nbsp;</td>
      <td width="200" class="tableBODY">First Name</td>
      <td><input name="firstname" type="text" class="formFIELD" id="firstname" value="" size="30" maxlength="50"></td>
    </tr>
    <tr> 
      <td class="tableREQUIRED">&nbsp;</td>
      <td width="200" class="tableBODY">Last Name</td>
      <td><input name="lastname" type="text" class="formFIELD" id="lastname" value="" size="30" maxlength="50"></td>
    </tr>
    <tr> 
      <td class="tableREQUIRED">&nbsp;</td>
      <td width="200" class="tableBODY">Zip code</td>
      <td><input name="zipcode" type="text" class="formFIELD" id="zipcode" value="" size="30" maxlength="20"></td>
    </tr>
    <tr> 
      <td class="tableREQUIRED">&nbsp;</td>
      <td width="200">&nbsp;</td>
    ...
    <tr> 
      <td class="tableREQUIRED">&nbsp;</td>
      <td width="200" class="tableSUBSECTION">Comments</td>
      <td>&nbsp;</td>
    </tr>
    <tr> 
      <td class="tableREQUIRED">&nbsp;</td>
      <td width="200" class="tableBODY">Do you have any specific requests or interests?</td>
      <td><textarea name="comments" cols="30" class="formFIELD" id="comments"></textarea></td>
    </tr>
    <tr> 
      <td class="tableREQUIRED">&nbsp;</td>
      <td width="200">&nbsp;</td>
      <td><br>
        ...
        <input name="register" type="submit" class="formBUTTON" id="register" value="Register"> 
